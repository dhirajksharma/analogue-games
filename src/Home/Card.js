...
class Card extends React.Component{
    ...
    render(){
        return (
            <div className={'mx-2 shadow-slate-800 shadow-md max-w-[500px] sm:max-w-[600px] min-h-[55vh] overflow-hidden rounded-lg flex flex-col justify-end '+this.props.imgurl}>
